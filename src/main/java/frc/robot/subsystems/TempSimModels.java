 ...
 */
public class TempSimModels extends SubsystemBase {
  ...
  public void periodic() {
    // Update pivot angle
    double currentAngleRad = 0; //pivot.getSimulation().getAngleRad();
    ...
    SmartDashboard.putNumber(
      ...
      Units.radiansToDegrees(0) //pivot.getSimulation().getVelocityRadPerSec())
    );
    SmartDashboard.putNumber(
      "Pivot Current (A)",
      0 //pivot.getSimulation().getCurrentDrawAmps()
    );
  }
}
